...
(function($) {
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                colors: ["#005683", "#0099D7", "#D43F26", "#FFAA31", "#C22439", "#673499"],
                legend: {
                    show: true,
                ...
                grid: {
                    ...
                    borderColor: "#F9F9F9", // set if different from the grid color
                    tickColor: "#DDD", // color for the ticks, e.g. "rgba(0,0,0,0.15)"
    ...
    $.plot.formatDate = function(d, fmt, monthNames) {
        ...
        var isAM = hours < 12;
        if (monthNames == null)
            monthNames = ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Agos", "Sep", "Oct", "Nov", "Dec"];
